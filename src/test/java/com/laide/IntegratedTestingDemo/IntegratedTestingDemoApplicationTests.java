...
@SpringBootTest(classes = IntegratedTestingDemoApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class IntegratedTestingDemoApplicationTests {
